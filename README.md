...
- `expense-reimbursement_safe.os` — the correct design.
- `expense-reimbursement_unsafe.os` — the tempting-but-wrong version (the negative example a model must learn to reject).
