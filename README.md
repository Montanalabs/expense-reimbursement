...
- `expense-reimbursement_safe.eide` — the correct design.
- `expense-reimbursement_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
